...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in protos/booking_pb2_grpc.py depends on'
...
class BookingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBookingByUserID = channel.unary_unary(
                ...
                request_serializer=protos_dot_booking__pb2.UserID.SerializeToString,
                response_deserializer=protos_dot_booking__pb2.BookingData.FromString,
                _registered_method=True)
        self.AddBooking = channel.unary_unary(
                '/Booking/AddBooking',
                request_serializer=protos_dot_booking__pb2.BookingRequest.SerializeToString,
                response_deserializer=protos_dot_booking__pb2.BookingResponse.FromString,
                _registered_method=True)
        self.GetAllBookings = channel.unary_stream(
                '/Booking/GetAllBookings',
                request_serializer=protos_dot_booking__pb2.BookingEmpty.SerializeToString,
                response_deserializer=protos_dot_booking__pb2.BookingData.FromString,
                _registered_method=True)
...
def add_BookingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetBookingByUserID': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_booking__pb2.UserID.FromString,
                    response_serializer=protos_dot_booking__pb2.BookingData.SerializeToString,
            ),
            'AddBooking': grpc.unary_unary_rpc_method_handler(
                    servicer.AddBooking,
                    request_deserializer=protos_dot_booking__pb2.BookingRequest.FromString,
                    response_serializer=protos_dot_booking__pb2.BookingResponse.SerializeToString,
            ),
            'GetAllBookings': grpc.unary_stream_rpc_method_handler(
                    servicer.GetAllBookings,
                    request_deserializer=protos_dot_booking__pb2.BookingEmpty.FromString,
                    response_serializer=protos_dot_booking__pb2.BookingData.SerializeToString,
            ),
    }
...
class Booking(object):
    ...
    def GetBookingByUserID(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Booking/GetBookingByUserID',
            protos_dot_booking__pb2.UserID.SerializeToString,
    ...
    def AddBooking(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Booking/AddBooking',
            protos_dot_booking__pb2.BookingRequest.SerializeToString,
            protos_dot_booking__pb2.BookingResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetAllBookings(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/Booking/GetAllBookings',
            protos_dot_booking__pb2.BookingEmpty.SerializeToString,
            protos_dot_booking__pb2.BookingData.FromString,
            options,
            channel_credentials,
            insecure,
